...
import { useAdminRegisterMutation } from '../../features/api/authApiSlice';
import LoginImg from '../../assets/images/login-img.png';
import { useNotification } from '../../context/NotificationContext';

const AdminRegister = () => {
    const navigate = useNavigate();
    const [adminRegistration] = useAdminRegisterMutation();
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const result = await adminRegistration({ payload }).unwrap();
        if (result) {
        ...
        <div className="auth__container">
          <div className="auth__form">
            <div className="auth__form--heading">
              <h2>Welcome</h2>
              <p>Create a new free account as a admin</p>
            </div>
